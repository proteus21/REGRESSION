...
if nav=="Information":
    st.markdown("<h1 style='text-align: center; color: grey;'>STOCK MARKET INDEX PREDICTION</h1>", unsafe_allow_html=True)
    left, middle, right = st.columns((1, 12, 2))
    with middle:
         st.image('Stock-Index.jpg',width=600)
...
if nav=="Predict":
        ...
        st.markdown("<h1 style='text-align: center; color: grey;'>Stock Index Prediction using Linear Regression</h1>",
